      ...
      <div className="grid lg:grid-cols-[1fr_320px] gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="card">
            ...
            <input
              className="input text-3xl display mb-4 py-2"
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="display text-2xl">Etapas</h2>
  ...
  return (
    <div className="bg-ivory border border-bone p-5 group animate-fade-up" style={{ animationDelay: `${index * 0.04}s` }}>
      <div className="flex items-start gap-4">
        <div className="display text-3xl text-rust w-8 flex-shrink-0">
          {step.orderIndex}
        </div>
      ...
      {steps.map((s) => (
        <div key={s.uid} className="text-xs">
          <div className="flex items-center gap-2">
            <span className="display text-base text-rust w-5 text-right">
              {s.orderIndex}
            </span>
